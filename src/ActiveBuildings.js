...
const ActiveBuildings = (props) => {
	...
	return (
		...
		<Box style={{"backgroundColor":"rgba(255,255,255,.75)", "marginBottom":"25px","maxWidth":"100%", "marginTop":"25px", "border":"2px black solid", "borderRadius":"10px", "minWidth":"450px", "width":"50%", "height":"75%"}}>
